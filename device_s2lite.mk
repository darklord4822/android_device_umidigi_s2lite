...
LOCAL_PATH := device/umidigi/s2lite

$(call inherit-product-if-exists, vendor/umidigi/s2lite/s2lite-vendor.mk)
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := $(LOCAL_PATH)/rootdir/kernel
else
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/init.mt6755.power.rc:root/init.mt6755.power.rc \
